...
<body>
    <div class="header">
        <h1>📚 Don't Forget to Download!</h1>
        <p>Hi {{ $user->name }}, you still have books waiting to be downloaded!</p>
    </div>

    <div class="content">
        <div class="reminder-section">
            <h2>⏰ Download Reminder</h2>
            <p>You purchased {{ count($undownloadedItems) }} book(s) {{ $daysSincePurchase }} day(s) ago, but haven't downloaded them yet.</p>
        ...
        <div class="download-section">
            ...
            <p>Your digital books are ready and waiting for you! Click the links below to access your purchases.</p>
        ...
        <div style="background: #e2e3e5; padding: 15px; border-radius: 5px; margin: 20px 0;">
            <h4>💡 Pro Tip:</h4>
            <p>Download your books as soon as possible to ensure you don't miss out on your reading time. Your books are ready whenever you are!</p>
        </div>
    </div>
